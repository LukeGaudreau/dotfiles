...
c.url.searchengines = {'DEFAULT': 'https://duckduckgo.com/?q={}',
                       'pr': 'http://bclib.bc.edu/libsearch/bc/keyword/{}',
                       'bw': 'https://bcwiki.bc.edu/dosearchsite.action?queryString={}',
...
config.bind('ZZ', 'config-cycle tabs.show multiple always')
...
### Aliases
c.aliases.update({ 'pnx': 'open -t {url}&showPnx=true'})
